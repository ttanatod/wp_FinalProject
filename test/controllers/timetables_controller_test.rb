...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { movie_id: @timetable.movie_id, theater_id: @timetable.theater_id, time_start: @timetable.time_start, time_stop: @timetable.time_stop } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { movie_id: @timetable.movie_id, theater_id: @timetable.theater_id, time_start: @timetable.time_start, time_stop: @timetable.time_stop } }
