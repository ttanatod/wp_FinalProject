...
class OrderlinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderline" do
    assert_difference('Orderline.count') do
      post orderlines_url, params: { orderline: { Product_id: @orderline.Product_id, order_id: @orderline.order_id, quantity: @orderline.quantity, totalPrice: @orderline.totalPrice } }
    end
  ...
  test "should update orderline" do
    patch orderline_url(@orderline), params: { orderline: { Product_id: @orderline.Product_id, order_id: @orderline.order_id, quantity: @orderline.quantity, totalPrice: @orderline.totalPrice } }
